...
var Menu = function () {
  function Menu(_ref) {
    ...
    this._elem.addEventListener('transitionend', function (event) {
      var newOpen = _this._elem.classList.contains('open');

      if (newOpen == _this.isOpen) return;

      var eventName = newOpen ? 'menu-open' : 'menu-close';

      _this._elem.dispatchEvent(new CustomEvent(eventName, {
        bubble: true
      }));

      _this.isOpen = _this._elem.classList.contains('open');
    });
  }
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (items, title) {pug_html = pug_html + "\u003Cdiv class=\"menu\"\u003E\u003Cspan class=\"title\"\u003E" + (pug.escape(null == (pug_interp = title) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cul\u003E";
// iterate items
;(function(){
  var $$obj = items;
...
pug_html = pug_html + "\u003Cli\u003E\u003Ca" + (pug.attr("href", item.href, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = item.title) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fli\u003E";
      }
  } else {
    var $$l = 0;
